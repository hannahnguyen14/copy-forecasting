...
from tsfb.base.origin_code.duet.utils.masking import ProbMask, TriangularCausalMask
...
class DSAttention(nn.Module):
    ...
    def forward(self, queries, keys, values, attn_mask, tau=None, delta=None):
        ...
        # De-stationary Attention, rescaling
        # pre-softmax score with learned de-stationary factors
...
class TwoStageAttentionLayer(nn.Module):
    ...
    def forward(self, x, attn_mask=None, tau=None, delta=None):
        ...
        # Cross Dimension Stage: use a small set of learnable
        # vectors to aggregate and distribute messages to build the D-to-D connection
        dim_send = rearrange(
