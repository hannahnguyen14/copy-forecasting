...
def annotate(**kwargs):
    ...
    :param kwargs: Keyword arguments representing
        the annotations to be added or updated.
...
class ModelBase(metaclass=abc.ABCMeta):
    ...
    def forecast_fit(
        ...
        **kwargs,
        ...
        :param train_ratio_in_tv: Represents the splitting
            ratio of the training set validation set.
